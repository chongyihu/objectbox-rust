...
impl<'a> entity<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        if let Some(x) = args.t_vec_string {
            builder.add_t_vec_string(x);
        }
        if let Some(x) = args.t_vec_u8 {
            builder.add_t_vec_u8(x);
        }
        if let Some(x) = args.t_string {
            builder.add_t_string(x);
        }
    ...
    pub fn t_bool(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(entity::VT_T_BOOL, Some(false))
                .unwrap()
        }
    }
    #[inline]
    ...
    pub fn t_string(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(entity::VT_T_STRING, None)
        }
    }
    #[inline]
...
impl flatbuffers::Verifiable for entity<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            >>("t_vec_string", Self::VT_T_VEC_STRING, false)?
            .finish();
        Ok(())
    }
}
...
impl<'a: 'b, 'b> entityBuilder<'a, 'b> {
    ...
    pub fn add_t_bool(&mut self, t_bool: bool) {
        self.fbb_
            .push_slot::<bool>(entity::VT_T_BOOL, t_bool, false);
    }
    #[inline]
    ...
    pub fn add_t_string(&mut self, t_string: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(entity::VT_T_STRING, t_string);
    }
    #[inline]
    pub fn add_t_vec_u8(&mut self, t_vec_u8: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(entity::VT_T_VEC_U8, t_vec_u8);
    }
    #[inline]
    pub fn add_t_vec_string(
        &mut self,
        t_vec_string: flatbuffers::WIPOffset<
            flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<&'b str>>,
        >,
    ) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(entity::VT_T_VEC_STRING, t_vec_string);
    }
    #[inline]
